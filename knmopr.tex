...
\draw [line width=1pt,decorate,decoration={brace,amplitude=10pt,mirror}](0,0) -- (12,0) node[midway,yshift=-4em] {\Large $\begin{aligned}v&=p\big[1\tdots (j-1)\big]\\&= t\big[(s+1)\tdots(s+j-1)\big]\end{aligned}$};
