...
\textbf{Beobachtung:} Finden wir ein \textit{Präfix $u$ des Musters $p$} im erfolgreich gescannten Teil $v$ von $p$ wieder, können wir dieses als \glqq Fallback\grqq-Position nutzen.\bigskip\bigskip
...
\draw [line width=1pt,decorate,decoration={brace,amplitude=10pt,mirror}](0,0) -- (12,0) node[midway,yshift=-2.1em] {\Large $v=p[1]\cdots p[j]$};

\end{tikzpicture}}
\end{center}%\pause
%Wir suchen also den \emph{größtmöglichen Rand} $u$ von $v$ für alle $v$.
\end{frame}
