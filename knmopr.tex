...
\cite{baeza1989}: Mit $c=\vert\Sigma\vert$ und $n\geq m$ beträgt die erwartete Anzahl an Vergleichen $\bar{C}_n$:
\[\bar{C}_n=\frac{c}{c-1}\left(1-\frac{1}{c^m}\right)(n-m+1)+\mathcal{O}(1)\]
\end{frame}
...
\item Wie viele Vergleiche dürfen wir überspringen, ohne dabei ein Vorkommen zu verpassen?
